 ...
 *
 * Muestra un texto con un botón para redirigir al usuario a la pantalla de registro.
 *
 * @param modifier Modificador opcional para aplicar estilos adicionales al composable.
 * @param onClick Función que se llama cuando el usuario hace clic en el enlace para registrarse.
 */

@Composable
fun SignUpLink(modifier: Modifier = Modifier, onClick: () -> Unit) {
    Row(
